...
<template>
    ...
    <div class="content-header" v-if="!loading">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Показания счётчика</h1>
                </div>
            </div>
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th>Дата</th>
                            <th>Объём потребляемой воды за период</th>
<!--                            <th>Редактировать</th>-->
                        </tr>
                        </thead>
                        <tbody>
                        <tr v-for="(record, index) in records">
                            ...
                            <th>{{ record['amount_volume'] }} м<sup>3</sup></th>
<!--                            Если надо редактировать потребление воды-->
                ...
                <Form ref="form" @submit="handleSubmit" :validation-schema="schema" v-slot="{ errors }">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="record" class="col-form-label">Объём потребляемой воды за период:</label>
                            <Field name="record" v-model="recordInput" type="text" class="form-control" :class="{ 'is-invalid': errors.record }" id="record" aria-describedby="nameHelp" placeholder="Введите объём потребляемой воды..."/>
