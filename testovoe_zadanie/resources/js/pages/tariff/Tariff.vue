                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tr v-for="(tariff, index) in tariffs">
                            <th>{{ index + 1 }}</th>
                            <th>{{ new Date(periods.find(per => per.id === tariff['period_id'])['end_date']).toLocaleString('default', { month: 'long', year: 'numeric' }) }}</th>
                            <th>{{ tariff['tariff'] }}₽ м<sup>3</sup></th>
